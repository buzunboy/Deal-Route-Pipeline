...
2. **Confirm the fetcher handles it** — static vs JS/anti-bot (→ stealth / real-browser adapter). If it's login-gated, it belongs in the **manual-capture** flow, not here.
...
6. Respect `robots.txt` / ToS and per-domain rate limits.
