...
- Cost stats: `npm run cli -- stats [--since YYYY-MM-DD] [--until YYYY-MM-DD]` (aggregate logged `crawl_runs.cost_eur` — total + per UTC day + per source; half-open window: since inclusive, until exclusive)
